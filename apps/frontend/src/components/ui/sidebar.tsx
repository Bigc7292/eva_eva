...
import { CalendarIcon, PhoneIcon, UsersIcon, BuildingIcon, DashboardIcon, BarChart3, Target } from "./icons"
...
// Define routes at the top to avoid hoisting issues
const routes = [
  {
    label: 'Dashboard',
    icon: DashboardIcon,
  ...
  {
    label: 'Phone Profiles',
    icon: PhoneIcon, // Changed from Phone to PhoneIcon to avoid conflicts
    href: '/phone-profiles',
  },
  {
    label: 'Calls',
