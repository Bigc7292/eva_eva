    ...
    payload = {
        "nodes": [
            ...
            # Thank you
            {
                "type": "say",
                "name": "ThankYou",
                "prompt": "Thank you for sharing your preferences. I'll help you find properties in {{location}} that match your criteria. A real estate specialist will contact you soon with options."
            },
